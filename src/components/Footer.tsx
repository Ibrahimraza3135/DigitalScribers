      ...
      <Helmet>
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "Organization",
            "name": "DigitalScribers",
            "url": "https://digitalscribers.com",
            "logo": "https://digitalscribers.com/logo.png", // replace with actual logo
            "sameAs": [
              "https://www.facebook.com/DigitalScribers",
              "https://twitter.com/DigitalScribers",
              "https://www.linkedin.com/company/DigitalScribers"
            ],
            "contactPoint": {
              "@type": "ContactPoint",
              "email": "james@digitalscribers.com",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="border-t border-zinc-900 mt-10 pt-6 text-center text-sm">
            <p className="text-gray-500">
              &copy; {currentYear} DigitalScribers. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
