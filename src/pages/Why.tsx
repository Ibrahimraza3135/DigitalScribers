...
export default function Why({ onNavigate }: WhyProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-[#FAF9F6] to-amber-50/20 pt-24 pb-12">
      {/* ================= SEO ================= */}
      <Helmet>
        <title>Why Choose Digital Scribers | Wikipedia Experts</title>
        <meta
          name="description"
          content="Learn why Digital Scribers is the leading Wikipedia service provider. We ensure your page is compliant, accurate, and maximizes survival chances."
        />
        <link rel="canonical" href="https://digitalscribers.com/why" />

        {/* Open Graph */}
        <meta property="og:title" content="Why Choose Digital Scribers | Wikipedia Experts" />
        <meta
        ...
        />
        <meta property="og:url" content="https://digitalscribers.com/why" />
